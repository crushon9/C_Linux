...
int	main()
{
	...
	printf("ex01\n");
	printf("s1 : %s\ns2 : %s\n", ex00_s1, ex00_s2);
	printf("strncmp, n=0 : %d\nstrncmp, n=20 : %d\n", strncmp(ex00_s1,ex00_s2, 0), strncmp(ex00_s1, ex00_s2, 20));
	printf("ft_strncmp, n=0 : %d\nft_strncmp, n=20 : %d\n\n\n", ft_strncmp(ex00_s1,ex00_s2, 0), ft_strncmp(ex00_s1, ex00_s2, 20));
	...
	printf("strncat, n=1 : %s\nstrncat, n=30 : %s\n", strncat(ex03_dest1,ex03_src1, 1), strncat(ex03_dest2, ex03_src2, 30));
	printf("ft_strncat, n=1 : %s\nft_strncat, n=30 : %s\n\n\n", ft_strncat(ex03_dest3,ex03_src3, 1), ft_strncat(ex03_dest4, ex03_src4, 30));
	...
	printf("strlcat, n=0 : %lu\nstrlcat, n=15 : %lu\n", strlcat(ex05_dest1, ex05_src1, 0), strlcat(ex05_dest2, ex05_src2, 15));
	printf("ft_strlcat, n=0 : %d\nft_strlcat, n=15 : %d\n\n", ft_strlcat(ex05_dest3, ex05_src3, 0), ft_strlcat(ex05_dest4, ex05_src4, 15));
}
